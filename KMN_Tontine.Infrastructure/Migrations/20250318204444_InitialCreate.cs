        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldeComptePrive = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembreComptes", x => new { x.MembreId, x.CompteId });
                    table.ForeignKey(
                        name: "FK_MembreComptes_AspNetUsers_MembreId",
                        column: x => x.MembreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MembreComptes_Comptes_CompteId",
                        column: x => x.CompteId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePromesse = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromessesPaiement", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PromessesPaiement_AspNetUsers_MembreId",
                        column: x => x.MembreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromessesPaiement_Comptes_CompteId",
                        column: x => x.CompteId,
                        principalTable: "Comptes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_AspNetUsers_MembreId",
                        column: x => x.MembreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comptes_AssociationId",
                table: "Comptes",
                column: "AssociationId");

            migrationBuilder.CreateIndex(
                name: "IX_MembreComptes_CompteId",
                table: "MembreComptes",
                column: "CompteId");

            migrationBuilder.CreateIndex(
                name: "IX_PromessesPaiement_CompteId",
                table: "PromessesPaiement",
                column: "CompteId");

            migrationBuilder.CreateIndex(
                name: "IX_PromessesPaiement_MembreId",
                table: "PromessesPaiement",
                column: "MembreId");
