...
namespace KMN_Tontine.Blazor.UI.Services.Base
{
    ...
    public partial interface IClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ListAsync(string path);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ListAsync(string path, System.Threading.CancellationToken cancellationToken);

        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task DownloadAsync(string filePath);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task DownloadAsync(string filePath, System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task ListAsync(string path)
        {
            return ListAsync(path, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task ListAsync(string path, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/FileSystem/list"
                    urlBuilder_.Append("api/FileSystem/list");
                    urlBuilder_.Append('?');
                    if (path != null)
                    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task DownloadAsync(string filePath)
        {
            return DownloadAsync(filePath, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task DownloadAsync(string filePath, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/FileSystem/download"
                    urlBuilder_.Append("api/FileSystem/download");
                    urlBuilder_.Append('?');
                    if (filePath != null)
                    {
        ...
        {
            return ByAccountAsync(accountId, System.Threading.CancellationToken.None);
        }
        ...
        {
            return ByMemberAsync(memberId, System.Threading.CancellationToken.None);
        }
        ...
        {
            return ByAccount2Async(accountId, System.Threading.CancellationToken.None);
        }
        ...
        {
            return ByMember2Async(memberId, System.Threading.CancellationToken.None);
        }
    ...
    public partial class TransactionResponse
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("paymentPromiseReference")]
    ...
    public partial class UpdateMemberRequest
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("portClient")]
